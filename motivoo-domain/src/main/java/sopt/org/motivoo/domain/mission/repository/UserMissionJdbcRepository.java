...
public class UserMissionJdbcRepository {


	private final JdbcTemplate jdbcTemplate;

	@Transactional
	public void bulkSave(List<User> users, LocalDate date, Mission mission, MissionQuest quest) {
		batchInsert(users.size(), users, date, mission, quest);
	}
